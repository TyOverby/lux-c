...
static test_case tests[] = {
    {"single_rect", test_single_rect, TEST_IMAGE},
    {"overlapping", test_overlapping, TEST_IMAGE},
    {"alpha_rects", test_alpha_rects, TEST_IMAGE},
    {"full_canvas", test_full_canvas, TEST_IMAGE},
    {"nested", test_nested, TEST_IMAGE},
    // fully out of region
    ...
    {"oob_partial_left", test_oob_partial_left, TEST_IMAGE},
    {"oob_partial_right", test_oob_partial_right, TEST_IMAGE},
    {"oob_partial_top", test_oob_partial_top, TEST_IMAGE},
    {"oob_partial_bottom", test_oob_partial_bottom, TEST_IMAGE},
    {"oob_partial_top_left", test_oob_partial_top_left, TEST_IMAGE},
    {"oob_partial_top_right", test_oob_partial_top_right, TEST_IMAGE},
    {"oob_partial_bottom_left", test_oob_partial_bottom_left, TEST_IMAGE},
    {"oob_partial_bottom_right", test_oob_partial_bottom_right, TEST_IMAGE},
};
